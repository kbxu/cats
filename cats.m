...
Version  = regexpi(help(mfilename),'Version: ([0-9]+\.[0-9]*.\w+)','tokens','once');
Datetime = fix(clock);
fprintf('*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*\n');
...
help_str = sprintf([...
                    ...
                    'left mouse click: mark foreground with green brush\n',...
                    'right mouse click: mark background with red brush\n',...
                    ...
                    'r: run semi-supervised learning to segment\n',...
                    'm: show/hide masks\n',...
